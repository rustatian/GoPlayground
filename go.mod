...
require (
	bitbucket.org/inturnco/go-sdk v0.1.21
	...
	github.com/ValeryPiashchynski/Sagas v0.0.0-20180815080100-fdf00ae219af
	...
	github.com/pierrec/lz4 v2.0.4+incompatible // indirect
